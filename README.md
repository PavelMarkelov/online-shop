...
получения на указанный администратором e-mail, html письма с вложением отчета в формате
...
средствами Hibernate в 9 классах.</p>
...
соответствующему сервлету, что позволяет реализовать в нем функцию аутентификации пользователя.
</p>
