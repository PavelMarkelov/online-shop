...
public class CustomerDtoEditWithValid extends PersonEditDtoWithValid {

    private String email;
    private String address;
    private String phone;

    public CustomerDtoEditWithValid(String firstName, String lastName, String patronymic,
                                    String oldPassword, String newPassword, String email, String address, String phone
    ) {
