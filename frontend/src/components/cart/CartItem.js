...
const CartItem = (props) => {
  ...
  const total = (
    props.product.count * props.product.price
      ...
      <div className="row no-gutters">
        ...
        <div className="col-md-8">
          <div className="card-body pb-0">
            <h5 className="ml-1 card-title mb-4" data-test="name">
              {props.product.name}
            </h5>
            <p className="ml-1 card-text">
              <strong>Price: </strong>
              <span className="text-success" data-test="total">
                ${total}
              </span>
            </p>
